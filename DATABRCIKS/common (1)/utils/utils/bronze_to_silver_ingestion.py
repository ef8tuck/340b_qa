...
print("AAA")
print(databricks_job_id)
print(databricks_run_id)
...
def source_to_target_data_load():
    ...
    try:
        ...
        #print(str(dq_summary))
        print("Ajay::"+str(databricks_run_id))
        print("Ajay::"+str(databricks_job_id))
        ...
        print(str(logging_input_params_insert))
